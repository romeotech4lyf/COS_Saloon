                        ...
                        for (DataSnapshot user : dataSnapshot.getChildren()) {
                            ...
                            if (usersBean != null) {
                                if (usersBean.getPassword().equals(password)) {
                                    dialog.dismiss();
                                    Toast.makeText(Login.this, "Login Success! for user " + usersBean.getName(), Toast.LENGTH_SHORT).show();
                                    ...
                                    if (usersBean.getIsAdmin().equals("true")) {
                                        Intent actDashboard = new Intent(Login.this, AdminHome.class);
                                        startActivity(actDashboard);
                                    } else {
                                        Intent actDashboard = new Intent(Login.this, UserHome.class);
                                        startActivity(actDashboard);
                                    }
